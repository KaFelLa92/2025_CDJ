...
// [3] 객체 선언 시 속성(Properties) 구성 , { 속성명 : 자료 , 속성명 : 자료 , 속성명 : 자료 }
// - 속성명과 자료 한 쌍(entry) , (쉼표) 구분하여 여러 개 쌍(entry)을 { }로 감싼다.
...
// [4] 객체 호출
// 변수명                   : 전체 호출
// 변수명.속성명            : 특정 속성의 자료 호출 * .(접근/도트 연산자) 특정한 위치(속성)로 이동한다는 뜻
// 변수명['속성명']         : 특정 속성의 자료 호출 * 속성명이 특수문자포함 또는 변수일때
// Object.keys(변수명)      : 객체 내 모든 속성명(key)를 배열로 반환
...
// [5] 객체 내 속성 추가 , 변수명.새로운속성명 = 자료 , 변수명["새로운속성명"] = 자료
obj2.속성명3 = true;
console.log(obj2);                      // {속성명1: 10, 속성명2: 'hello', 속성명3: true}

// [6] 객체 내 속성 수정 , 변수명.속성명 = 새로운자료 , 변수명['속성명'] = 새로운자료
obj2.속성명1 = 20;
console.log(obj2);                      // {속성명1: *20, 속성명2: "hello", 속성명3: true}

// [7] 객체 내 속성 삭제 , delete 변수명.삭제속성명
delete obj2.속성명3;
console.log(obj2);                      // {속성명1: 20, 속성명2: "hello"}

// [8] 객체 속성 내 자료 , 자료에는 변수값, 리터럴값, 객체, 배열, 함수 등 모든 자료가 대입된다.
let var1 = 10;
const var2 = {
...
// [9] in 연산자 , 객체 내 특정한 속성이 있는지 확인(true/false)
...
// { {제품정보1} , {제품정보2 } } -> 객체보다는 배열 권장
const products = [{ '제품명': '콜라', '가격': 1000 }, { '제품명': '사이다', '가격': 2000 }];
// + 반복문 : 변수가 참조하는 정보를 찾아가기(껍질까지)
// 제품목록(변수) -> 요소(배열) -> 속성값(객체)
for (let index = 0; index <= products.length - 1; index++) {
    const product = products[index]; //index번째 제품(객체)
