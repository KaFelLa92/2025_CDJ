...
/*
[변수]
    1. 정의 : - *하나*의 자료를 담아두는 (메모리) 공간
    2. 목적 : 재사용성, 가독성
    3. 사용법
        (변수를 선언하는 방법1) : 초기값이 없다. *초기값이란? 변수 선언할 때 초기에 대입되는 값
            let 변수명
    ...
    4. 형태
        ...
        2. 변수명   : 메모리 공간의 상징적인 이름
            * 카멜표기법 : mycar -> myCar , studentscore -> studentScore
...
[상수]
    1. 정의 : 변수와 같이 하나의 자료/데이터를 담아두는 공간이면서 수정 불가능한 변수
    2. 목적 : 절댓값, 협업간 코드를 바꾸면 안 될때 사용.
    3. 사용법
        const 변수명 = 초기값       *상수는 무조건 초기값 필요.
    4. 형태
        1. const    : 상수를 선언하기 위한 키워드/예약어
        2. 변수명   * 전체대문자 : pi -> PI
        3. =
        4. 자료     : 상수(고정)로 저장할 자료
...
// 2. 변수를 호출하는 방법 , 변수명
console.log( 이름1 )    // undefined (변수선언 되었으나 값 없음)
console.log( 이름2 )    // 유재석 , 이름2라는 변수가 가지는 변수값 호출

// 3. 변수의 값을 수정하는 방법 , 변수명 = 새로운값
이름1 = "강호동"        // 이름1 변수 호출하여 새로운값 대입
이름2 = "유재석2"       // 이름2 변수 호출하여 새로운값 대입
console.log( 이름1 )    // 강호동
...
// 3. *상수의 값을 수정하는 방법은 없다.*
이름3 = "신동엽2" // 오류발생 : Assignment to constant variable.

// [생각해보기1]
let point1 = 50 // 변수 : point1 , 리터럴 : 50
let point4 = 50 // 변수 : point4 , 리터럴 50 ( *point )
let point2 = 100 // 변수 : point2 , 리터럴 : 100
