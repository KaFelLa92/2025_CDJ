...
/*
    ...
    객체란 ? 속성(Property)와 함수(function)를 하나로 묶은 자료
        - 변수명.속성명                             : 객체내 속성값 호출
        - 변수명.속성명()                           : 객체내 함수 호출
            console(객체).log(함수)                 : console 객체내 log 함수 호출
    ...
    [ DOM객체 ]
        ...
        3. 내장객체내 주요 속성 
            ...
            3. document.querySelectorAll('선택자)   : HTML에 지정한 선택자를 *모두* JS객체(배열)로 반환하는 함수
                * 선택자 : 1.마크업명 2. .클래스명 3. #id명
            4. dom객체.innerHTML                    : 마크업내 html 호출하는 속성
                * <마크업> !!!여기가 innerHTML입니다. </마크업>
                * inner없음 : <input /> , <img />
            5. dom객체.value
                * <마크업 value="여기!!" / >
                *  value있음 : <input> , <select> , <textarea> 등
                *  value없음 : <div> , <span> , <table> 등
...
// 매개변수 : x , 반환값 : x , 로직 : 콘솔출력 등 하단 참고
function func1() {   // 함수 선언
    console.log('--- func1 exe ---')
    // 1. 콘솔출력
    const myInput = document.querySelector('.myInput');
    // 2. input 마크업 JS객체로 가져오기
...
function func3(){
    ...
    // 2. 해당 마크업객체내 .style속성
    title2.style = 'color : red; font-size : 8px;' // css문법을 문자열로 대입
    // *
    const body = document.querySelector('body');
    body.style.backgroundColor = 'black'; // 왔다갔다 하려면 if swich 이용
    // *
    title2.classList.toggle('myStyle'); // 토글은 넣다뺐다 가능. add는 넣기만 가능.
